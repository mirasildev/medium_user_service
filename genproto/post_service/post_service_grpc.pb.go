...
type PostServiceClient interface {
	...
	Delete(ctx context.Context, in *GetPost, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *postServiceClient) Delete(ctx context.Context, in *GetPost, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type PostServiceServer interface {
	...
	Delete(context.Context, *GetPost) (*emptypb.Empty, error)
...
func (UnimplementedPostServiceServer) Delete(context.Context, *GetPost) (*emptypb.Empty, error) {
...
func _PostService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Delete(ctx, req.(*GetPost))
	}
	return interceptor(ctx, in, info, handler)
}
