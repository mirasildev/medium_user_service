...
type CategoryServiceClient interface {
	...
	Delete(ctx context.Context, in *GetCategory, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *categoryServiceClient) Delete(ctx context.Context, in *GetCategory, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type CategoryServiceServer interface {
	...
	Delete(context.Context, *GetCategory) (*emptypb.Empty, error)
...
func (UnimplementedCategoryServiceServer) Delete(context.Context, *GetCategory) (*emptypb.Empty, error) {
